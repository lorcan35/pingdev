...
export function HomePage() {
    ...
    return (<div className="page">
      ...
      <div className="grid">
        <div className="col">
          {apps.length === 0 ? (<div className="panel">
              ...
              {apps.map(app => (<div key={app.port} onDoubleClick={() => navigate(`/app/${app.port}`)}>
      ...
      {showAdd && (<div className="modal" role="dialog" aria-modal="true">
