...
export class ExtensionBridge {
    ...
    pending = new Map(); // requestId -> promise handlers
    ...
    async callDevice(params) {
        ...
        const payloadObj = params.payload && typeof params.payload === 'object' ? params.payload : undefined;
            ...
            try {
                ...
                if (msg.type === 'device_response') {
                    ...
                    if (msg.ok)
                        ...
                        pending.reject(EIO('extension', msg.error ?? 'unknown error'));
                    return;
                }
                if (msg.type === 'ping') {
                    if (clientId)
...
//# sourceMappingURL=ext-bridge.js.map